<div class="wpbel-wrap">
    <div class="wpbel-tab-middle-content">
        <div class="wpbel-alert wpbel-alert-default">
            <span><?php esc_html_e('You can add new posts meta fields in two ways: 1- Individually 2- Get from other post.', WPBEL_NAME); ?></span>
        </div>
        ...
        <div class="wpbel-meta-fields-left">
            <div class="wpbel-meta-fields-manual">
                <label><?php esc_html_e('Manually', WPBEL_NAME); ?></label>
                <div class="wpbel-meta-fields-manual-field">
                    <input type="text" placeholder="<?php esc_html_e('Enter Meta Key ...', WPBEL_NAME); ?>" disabled="disabled">
            ...
            <div class="wpbel-meta-fields-automatic">
                <label><?php esc_html_e('Automatically From post', WPBEL_NAME); ?></label>
                <div class="wpbel-meta-fields-automatic-field">
                    <input type="text" placeholder="<?php esc_html_e('Enter Post ID ...', WPBEL_NAME); ?>" disabled="disabled">
                    <button type="button" class="wpbel-button wpbel-button-square wpbel-button-blue" disabled="disabled">
                        <i class="lni lni-plus wpbel-m0"></i>
                    </button>
                </div>
        ...
        <div class="wpbel-meta-fields-right" id="wpbel-meta-fields-items">
            <p class="wpbel-meta-fields-empty-text" <?php echo (!empty($meta_fields)) ? 'style="display:none";' : ''; ?>><?php echo sprintf(__('Please add your meta key manually %s OR %s From another post', WPBEL_NAME), '<br>', '<br>'); ?></p>
        </div>
        <div class="wpbel-meta-fields-buttons">
            <div class="wpbel-meta-fields-buttons-left">
                <button type="button" class="wpbel-button wpbel-button-lg wpbel-button-blue" disabled="disabled">
                    ...
                    <span><?php esc_html_e('Save Fields', WPBEL_NAME); ?></span>
                </button>
            </div>
        </div>
    </div>
