<div class="wpbel-wrap">
    <div class="wpbel-tab-middle-content">
        <div class="wpbel-alert wpbel-alert-default">
            <span><?php esc_html_e('List of your changes and possible to roll back to the previous data', WPBEL_NAME); ?></span>
        </div>
        ...
        <div class="wpbel-history-filter">
            <div class="wpbel-history-filter-fields">
                <div class="wpbel-history-filter-field-item">
                    <label for="wpbel-history-filter-operation"><?php esc_html_e('Operation', WPBEL_NAME); ?></label>
                ...
                <div class="wpbel-history-filter-field-item">
                    <label for="wpbel-history-filter-author"><?php esc_html_e('Author', WPBEL_NAME); ?></label>
                ...
                <div class="wpbel-history-filter-field-item">
                    <label for="wpbel-history-filter-fields"><?php esc_html_e('Fields', WPBEL_NAME); ?></label>
                ...
                <div class="wpbel-history-filter-field-item wpbel-history-filter-field-date">
                    <label><?php esc_html_e('Date', WPBEL_NAME); ?></label>
                    <input type="text" id="wpbel-history-filter-date-from" class="wpbel-datepicker wpbel-date-from" data-to-id="wpbel-history-filter-date-to" placeholder="<?php esc_html_e('From ...', WPBEL_NAME); ?>">
                    <input type="text" id="wpbel-history-filter-date-to" class="wpbel-datepicker" placeholder="<?php esc_html_e('To ...', WPBEL_NAME); ?>">
                </div>
            </div>
            <div class="wpbel-history-filter-buttons">
                ...
                <div class="wpbel-history-filter-buttons-right">
                    <button type="button" name="clear_all" value="1" id="wpbel-history-clear-all-btn" class="wpbel-button wpbel-button-lg wpbel-button-red" disabled="disabled">
                        ...
                        <span><?php esc_html_e('Clear History', WPBEL_NAME); ?></span>
                    </button>
                </div>
            </div>
        </div>
        <div class="wpbel-history-items">
            <h3><?php esc_html_e('Column(s)', WPBEL_NAME); ?></h3>
            <div class="wpbel-table-border-radius">
                <table>
                    <thead>
                        <tr>
                            <th>#</th>
                            <th><?php esc_html_e('History Name', WPBEL_NAME); ?></th>
                            <th><?php esc_html_e('Author', WPBEL_NAME); ?></th>
                            <th class="wpbel-mw125"><?php esc_html_e('Date Modified', WPBEL_NAME); ?></th>
                            <th class="wpbel-mw250"><?php esc_html_e('Actions', WPBEL_NAME); ?></th>
                        </tr>
                    </thead>
                    <tbody>
