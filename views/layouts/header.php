<div id="wpbel-main">
    <div id="wpbel-loading" class="wpbel-loading">
        <?php esc_html_e('Loading ...', WPBEL_NAME) ?>
    </div>
    <div id="wpbel-header">
        <div class="wpbel-plugin-title">
            ...
            <span><?php esc_html_e("Be professionals with managing data in the reliable and flexible way!", WPBEL_NAME); ?></span>
        </div>
        <div class="wpbel-header-left">
            <div class="wpbel-plugin-help">
                <span>
                    <a href="<?php echo (!empty($doc_link)) ? esc_attr($doc_link) : '#'; ?>"><strong class="wpbel-plugin-help-text"><?php esc_html_e('Need Help', WPBEL_NAME); ?></strong> <i class="lni-help"></i></a>
                </span>
            </div>
