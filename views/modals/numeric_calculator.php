        ...
        <div class="wpbel-modal-box wpbel-modal-box-sm">
            <div class="wpbel-modal-content">
                <div class="wpbel-modal-title">
                    <h2><?php esc_html_e('Calculator', WPBEL_NAME); ?> - <span id="wpbel-modal-numeric-calculator-item-title" class="wpbel-modal-product-title"></span></h2>
                ...
                <div class="wpbel-modal-body">
                    <div class="wpbel-wrap">
                        <select id="wpbel-numeric-calculator-operator" title="<?php esc_html_e('Select Operator', WPBEL_NAME); ?>">
                            <option value="+">+</option>
                            <option value="-">-</option>
                            <option value="replace"><?php esc_html_e('replace', WPBEL_NAME); ?></option>
                        </select>
                        <input type="number" placeholder="<?php esc_html_e('Enter Value ...', WPBEL_NAME); ?>" id="wpbel-numeric-calculator-value" title="<?php esc_html_e('Value', WPBEL_NAME); ?>">
                    </div>
                </div>
