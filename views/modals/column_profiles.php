        ...
        <div class="wpbel-modal-box wpbel-modal-box-lg">
            <div class="wpbel-modal-content">
                <div class="wpbel-modal-title">
                    <h2><?php esc_html_e('Column Profiles', WPBEL_NAME); ?></h2>
                ...
                <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
                    ...
                    <div class="wpbel-modal-body">
                        <div class="wpbel-wrap">
                            <div class="wpbel-alert wpbel-alert-default">
                                <span><?php esc_html_e('You can load saved column profile presets through Column Manager. You can change the columns and save your changes too.', WPBEL_NAME); ?></span>
                            </div>
                            <div class="wpbel-column-profiles-choose">
                                <label for="wpbel-column-profiles-choose"><?php esc_html_e('Choose Preset', WPBEL_NAME); ?></label>
                    ...
                    <div class="wpbel-modal-footer">
                        <button type="submit" class="wpbel-button wpbel-button-blue wpbel-float-left" id="wpbel-column-profiles-apply" data-preset-key="<?php echo (!empty($first_key)) ? $first_key : ''; ?>">
                            <?php esc_html_e('Apply To Table', WPBEL_NAME); ?>
                        </button>
                        <div class="wpbel-column-profile-search wpbel-float-right">
                            <label for="wpbel-column-profile-search"><?php esc_html_e('Search', WPBEL_NAME); ?> </label>
                            <input type="text" id="wpbel-column-profile-search" placeholder="<?php esc_html_e('Search Column ...', WPBEL_NAME); ?>">
                        </div>
                    </div>
                </form>
            </div>
