        ...
        <div class="wpbel-modal-box wpbel-modal-box-sm">
            <div class="wpbel-modal-content">
                ...
                <div class="wpbel-modal-body">
                    <div class="wpbel-wrap">
                        <div class="wpbel-form-group">
                            ...
                            <input type="number" class="wpbel-input-numeric-sm wpbel-m0" id="wpbel-new-item-count" value="1" placeholder="<?php esc_html_e('Number ...', WPBEL_NAME); ?>">
                        </div>
                ...
                <div class="wpbel-modal-footer">
                    <button type="button" class="wpbel-button wpbel-button-blue" id="wpbel-create-new-item"><?php esc_html_e('Create', WPBEL_NAME); ?></button>
                </div>
            </div>
        </div>
    </div>
