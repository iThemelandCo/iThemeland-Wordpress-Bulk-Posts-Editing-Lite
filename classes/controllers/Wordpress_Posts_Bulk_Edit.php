...
class Wordpress_Posts_Bulk_Edit
{
    public function index()
    {
        ...
        $title = esc_html__('Wordpress Bulk Posts Editing Lite', WPBEL_NAME);
        $doc_link = "https://ithemelandco.com/Plugins/Documentations/Pro-Bulk-Editing/wordpress-bulk-posts-editing/documentation.pdf";
        $tabs_title = [
            'bulk-edit' => esc_html__('Bulk Edit', WPBEL_NAME),
            'column-manager' => esc_html__('Column Manager', WPBEL_NAME),
            'meta-fields' => esc_html__('Meta Fields', WPBEL_NAME),
            'history' => esc_html__('History', WPBEL_NAME),
            'import-export' => esc_html__('Import/Export', WPBEL_NAME),
            'settings' => esc_html__('Settings', WPBEL_NAME),
            'activation' => esc_html__('Activation', WPBEL_NAME),
        ];
        $tabs_content = [
            ...
            'activation' => WPBEL_VIEWS_DIR . "activation/main.php",
        ];
        $is_active = WPBEL_Verification::is_active();
        $activation_skipped = WPBEL_Verification::skipped();
