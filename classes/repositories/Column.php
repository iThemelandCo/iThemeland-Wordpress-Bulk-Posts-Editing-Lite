...
class Column
{
    ...
    public static function get_static_columns()
    {
        return [
            'post_title' => [
                'field' => 'post_title',
                'title' => esc_attr__('Title', WPBEL_NAME)
            ]
        ];
    }
    ...
    private function get_all_columns()
    {
        ...
        return [
            '_thumbnail_id' => [
                'label' => esc_html__('Thumbnail', WPBEL_NAME),
                'title' => esc_html__('Thumbnail', WPBEL_NAME),
                'editable' => true,
                'content_type' => 'image',
            ...
            'post_content' => [
                'label' => esc_html__('Description', WPBEL_NAME),
                'title' => esc_html__('Description', WPBEL_NAME),
                'editable' => true,
            ...
            'post_excerpt' => [
                'label' => esc_html__('Short Description', WPBEL_NAME),
                'title' => esc_html__('Short Description', WPBEL_NAME),
                'editable' => true,
                'content_type' => 'textarea',
                'background_color' => '#fff',
                'text_color' => '#444',
            ...
            'post_name' => [
                'label' => esc_html__('Slug', WPBEL_NAME),
                'title' => esc_html__('Slug', WPBEL_NAME),
                'editable' => true,
                'content_type' => 'text',
                'background_color' => '#fff',
                'text_color' => '#444',
            ...
            'comment_status' => [
                'label' => esc_html__('Comment Status', WPBEL_NAME),
                'title' => esc_html__('Comment Status', WPBEL_NAME),
                'editable' => true,
                'content_type' => 'select',
                'options' => [
                    'open' => esc_html__('Open', WPBEL_NAME),
                    'closed' => esc_html__('Closed', WPBEL_NAME)
                ],
                'background_color' => '#fff',
                'text_color' => '#444',
            ],
            'post_status' => [
                'label' => esc_html__('Status', WPBEL_NAME),
                'title' => esc_html__('Status', WPBEL_NAME),
                'editable' => true,
                'content_type' => 'select',
            ...
            'ping_status' => [
                'label' => esc_html__('Ping Status', WPBEL_NAME),
                'title' => esc_html__('Ping Status', WPBEL_NAME),
                'editable' => true,
                'content_type' => 'select',
                'options' => [
                    'open' => esc_html__('Open', WPBEL_NAME),
            ...
            'post_password' => [
                'label' => esc_html__('Post Password', WPBEL_NAME),
                'title' => esc_html__('Post Password', WPBEL_NAME),
                'editable' => true,
                'content_type' => 'text',
                'background_color' => '#fff',
                'text_color' => '#444',
            ...
            'post_type' => [
                'label' => esc_html__('Post Type', WPBEL_NAME),
                'title' => esc_html__('Post Type', WPBEL_NAME),
                'editable' => true,
                'content_type' => 'select',
                'options' => $post_types,
                'background_color' => '#fff',
            ...
            'menu_order' => [
                'label' => esc_html__('Menu order', WPBEL_NAME),
                'title' => esc_html__('Menu order', WPBEL_NAME),
                'editable' => true,
            ...
            'post_author' => [
                'label' => esc_html__('Author', WPBEL_NAME),
                'title' => esc_html__('Author', WPBEL_NAME),
                'editable' => true,
                'content_type' => 'select',
                'options' => $authors,
                'background_color' => '#fff',
            ...
            'post_date' => [
                'label' => esc_html__('Date Published', WPBEL_NAME),
                'title' => esc_html__('Date Published', WPBEL_NAME),
                'editable' => true,
                'sortable' => true,
                'content_type' => 'date',
                'background_color' => '#fff',
            ...
            'post_date_gmt' => [
                'label' => esc_html__('GMT Date Published', WPBEL_NAME),
                'title' => esc_html__('GMT Date Published', WPBEL_NAME),
                'editable' => true,
                'sortable' => true,
                'content_type' => 'date',
                'background_color' => '#fff',
            ...
            'post_modified' => [
                'label' => esc_html__('Date Modified', WPBEL_NAME),
                'title' => esc_html__('Date Modified', WPBEL_NAME),
                'editable' => true,
                'sortable' => true,
                'content_type' => 'date',
                'background_color' => '#fff',
            ...
            'post_modified_gmt' => [
                'label' => esc_html__('GMT Date Modified', WPBEL_NAME),
                'title' => esc_html__('GMT Date Modified', WPBEL_NAME),
                'editable' => true,
                'sortable' => true,
                'content_type' => 'date',
                'background_color' => '#fff',
            ...
            'post_parent' => [
                'label' => esc_html__('Parent', WPBEL_NAME),
                'title' => esc_html__('Parent', WPBEL_NAME),
                'editable' => true,
            ...
            'sticky' => [
                'label' => esc_html__('Sticky', WPBEL_NAME),
                'title' => esc_html__('Sticky', WPBEL_NAME),
                'editable' => true,
                'content_type' => 'select',
                'options' => [
                    'yes' => esc_html__('Yes', WPBEL_NAME),
                    'no' => esc_html__('No', WPBEL_NAME)
                ],
                'background_color' => '#fff',
                'text_color' => '#444',
            ],
            'post_url' => [
                'label' => esc_html__('Post URL', WPBEL_NAME),
                'title' => esc_html__('Post URL', WPBEL_NAME),
                'editable' => true,
                'content_type' => 'text',
                'background_color' => '#fff',
                'text_color' => '#444',
            ...
            'ping_status' => [
                'label' => esc_html__('Allow Pingback', WPBEL_NAME),
                'title' => esc_html__('Allow Pingback', WPBEL_NAME),
                'editable' => true,
                'content_type' => 'select',
                'options' => [
                    'open' => esc_html__('Yes', WPBEL_NAME),
                    'closed' => esc_html__('No', WPBEL_NAME)
                ],
                'background_color' => '#fff',
                'text_color' => '#444',
            ],
